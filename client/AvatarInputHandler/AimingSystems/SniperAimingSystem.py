...
class SniperAimingSystem(IAimingSystem):
    ...
    def getPitchLimits(self, turretYaw = 0.0):
        if self._vehicleTypeDescriptor.isHullAimingAvailable and self.__siegeState == VEHICLE_SIEGE_STATE.ENABLED:
            return self.getDynamicPitchLimits(turretYaw)
        return self._vehicleTypeDescriptor.gun.pitchLimits
