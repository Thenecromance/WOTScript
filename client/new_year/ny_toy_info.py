...
class NewYear20ToyInfo(_NewYearBackportToyInfo):
    ...
    def getEmptyPassepartout(self):
        if self.isMega():
            return R.images.gui.maps.icons.newYear.albums.c_2020.passepartout.mega_empty()
        return R.images.gui.maps.icons.newYear.albums.c_2020.passepartout.empty()
...
class NewYear21ToyInfo(_NewYearBackportToyInfo):
    ...
    def getEmptyPassepartout(self):
        if self.isMega():
            return R.images.gui.maps.icons.newYear.albums.c_2021.passepartout.mega_empty()
        return R.images.gui.maps.icons.newYear.albums.c_2021.passepartout.empty()
...
class NewYear22ToyInfo(_NewYearBackportToyInfo):
    ...
    def getEmptyPassepartout(self):
        if self.isMega():
            return R.images.gui.maps.icons.newYear.albums.c_2022.passepartout.mega_empty()
        return R.images.gui.maps.icons.newYear.albums.c_2022.passepartout.empty()
