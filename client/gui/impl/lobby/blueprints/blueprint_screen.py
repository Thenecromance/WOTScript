...
class BlueprintScreen(ViewImpl):
    ...
    def __getTooltipData(self, ttId, itemCD):
        ...
        elif ttId == BlueprintScreenTooltips.TOOLTIP_BLUEPRINT_CONVERT_COUNT:
            return createTooltipData(isSpecial=True, specialAlias=TOOLTIPS_CONSTANTS.BLUEPRINT_CONVERT_INFO, specialArgs=[self.__vehicle.intCD])
        else:
            return