...
class ProgressiveRewardWindow(LobbyNotificationWindow):
    __slots__ = ()

    def __init__(self, contentResId, *args, **kwargs):
        super(ProgressiveRewardWindow, self).__init__(layer=WindowLayer.OVERLAY, content=ProgressiveRewardView(contentResId, *args, **kwargs), parent=None)
        return