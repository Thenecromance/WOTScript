...
class WTEventCrewView(ViewImpl, IGlobalListener):
    ...
    def __getBackportTooltipData(self, event):
        ...
        if not tooltipId:
            return None
        elif tooltipId == WtEventCrewModel.SKILL_TOOLTIP:
            return TooltipData(tooltip=tooltipId, isSpecial=True, specialAlias=tooltipId, specialArgs=[_SIXTH_SENSE, int(event.getArgument('invID'))])
        else:
            return None