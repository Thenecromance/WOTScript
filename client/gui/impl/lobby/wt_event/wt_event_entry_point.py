...
class WTEventEntryPoint(ViewImpl, Notifiable):
    ...
    def __getState(self):
        if self.__eventController.isInPrimeTime() and not self.__eventController.isFrozen():
            return WtEventEntryPointModel.STATE_ACTIVE
        return WtEventEntryPointModel.STATE_NOBATTLE