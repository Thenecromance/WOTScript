...
class WtEventBasePortalAwards(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        if contentID == R.views.lobby.wt_event.tooltips.WtEventBuyLootBoxesTooltipView():
    ...
    def _onClose(self):
        self._eventCtrl.getLootBoxAreaSoundMgr().leave()
        g_eventBus.handleEvent(events.WtEventPortalsEvent(events.WtEventPortalsEvent.ON_ALL_PORTAL_VIEWS_CLOSED), scope=EVENT_BUS_SCOPE.LOBBY)
        self.destroyWindow()
