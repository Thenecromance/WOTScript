...
class _LootBoxAutoOpenView(ViewImpl):
    ...
    def __updateBoxesInfo(self):
        premiumBoxesCount = commonBoxesCount = giftSurpriseBoxesCount = 0
        for lootbox in self.itemsCache.items.tokens.getLootBoxes().itervalues():
            ...
            elif lootbox.getType() == NewYearLootBoxes.SPECIAL:
                giftSurpriseBoxesCount += count
            else:
        ...
        with self.viewModel.transaction() as tx:
            ...
            tx.setGiftsQuantity(giftSurpriseBoxesCount)
    ...
    def __getGroupsLayout():
        ...
        layout = (RewardsGroup(name=groupNamesRes.vehicles(), bonusTypes=('vehicles',), bonuses={}, filterFuncs=None),
         ...
         RewardsGroup(name=groupNamesRes.toys(), bonusTypes=(CurrentNYConstants.TOYS, CurrentNYConstants.TOY_FRAGMENTS), bonuses={}, filterFuncs=None),
