...
class NyGiftSystemView(HistorySubModelPresenter, GiftEventHubWatcher):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        if event.contentID == R.views.lobby.new_year.tooltips.NyBroTokenTooltip():
            return NyBroTokenTooltip()
        return super(NyGiftSystemView, self).createToolTipContent(event, contentID)
