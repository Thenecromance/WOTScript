...
class NyLootBoxStatisticsPopover(PopOverViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        if contentID == R.views.lobby.new_year.tooltips.NyCustomizationsStatisticsTooltip():
            return NyCustomizationsStatisticsTooltip(self.__lootboxID)
        return super(NyLootBoxStatisticsPopover, self).createToolTipContent(event, contentID)
    ...
    def __getStatistics(self, lootboxID):
        ...
        if statsKey is None:
            ...
            return self.__itemsCache.items.tokens.getLootBoxesStats().get(statsKey, (rewardsData, boxesCount))
