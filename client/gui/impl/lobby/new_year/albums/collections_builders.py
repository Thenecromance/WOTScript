# Embedded file name: scripts/client/gui/impl/lobby/new_year/albums/collections_builders.py
import typing
from collections import defaultdict
from gui.impl.lobby.new_year.albums.toy_page_presenter import NYToyPagePresenter, ToyOldPagePresenter
...
class NY22SubCollectionBuilder(_SubCollectionBuilder):
    YEAR_NAME = Collections.NewYear22
    ORDER = (ToySettings.NEW_YEAR,
     ToySettings.ORIENTAL,
     ToySettings.FAIRYTALE,
     ToySettings.CHRISTMAS,
