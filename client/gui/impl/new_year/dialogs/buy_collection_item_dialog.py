...
class BuyCollectionItemDialogWindow(DialogWindow):
    ...
    def __init__(self, toy, parent = None):
        self.__toy = toy
        super(BuyCollectionItemDialogWindow, self).__init__(bottomContent=DialogContent(R.views.lobby.new_year.components.new_year_common.CollectionItemBottomContent(), viewModelClazz=CurrencyItemModel), balanceContent=DialogContent(R.views.lobby.new_year.components.new_year_common.CollectionItemBalanceContent(), viewModelClazz=CurrencyItemModel), parent=parent, enableBlur=True)
