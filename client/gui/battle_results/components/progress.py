...
class VehicleProgressBlock(base.StatsBlock):
    ...
    def __getReady2UnlockItemsVOs(helper, vehicleBattleXp):
        ...
        for item, unlockProps, _ in ready2UnlockVehicles:
            ...
            if helper.isEnoughXPToUnlock(unlockProps) or 0 < avgBattles2Unlock <= MIN_BATTLES_TO_SHOW_PROGRESS:
                ready2UnlockVehiclesVOs.append(_makeUnlockVehicleVO(item, unlockProps, avgBattles2Unlock))
