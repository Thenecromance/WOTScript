...
class LootBoxesController(ILootBoxesController):
    ...
    def getCollectionType(self, itemID):
        ...
        elif self.isCollectionElement(itemID, self.__gameCtrl.getBossCollection()):
            return EventCollections.BOSS
        else:
            return None
    ...
    def getAvailableForPurchaseLootBoxesCount(self):
        ...
        if availableLootBoxesCount > 0:
            return availableLootBoxesCount
        return 0
