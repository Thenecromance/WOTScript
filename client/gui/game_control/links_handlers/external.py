...
from gui.shared.event_dispatcher import showShop, showHangar, showEventCollectionWindow
    ...
    def handle(self, url):
        ...
        if self._GO_TO_META in param:
            ...
            if self.gameEventCtrl.isWelcomeScreenShown():
                self.gameEventCtrl.doSelectEventPrbAndCallback(showEventCollectionWindow)
            else:
