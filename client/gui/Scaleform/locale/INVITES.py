...
class INVITES(object):
    ...
    INVITES_NOTE_LEAVE_PREBATTLE_MAPS_TRAINING = '#invites:invites/note/leave/PREBATTLE_MAPS_TRAINING'
    INVITES_NOTE_CHANGE_AND_LEAVE_PREBATTLE_MAPS_TRAINING = '#invites:invites/note/change_and_leave/PREBATTLE_MAPS_TRAINING'
