...
class QUESTS(object):
    ...
    MISSIONS_TAB_SABATON_MARATHON = '#quests:missions/tab/sabaton_marathon'
    ...
    MISSIONS_TAB_LABEL_SABATON_MARATHON = '#quests:missions/tab/label/sabaton_marathon'
    MISSIONS_TAB_SABATON_MARATHON_HEADER = '#quests:missions/tab/sabaton_marathon/header'
    MISSIONS_TAB_SABATON_MARATHON_BODY = '#quests:missions/tab/sabaton_marathon/body'
