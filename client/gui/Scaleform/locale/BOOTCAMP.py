...
class BOOTCAMP(object):
    ...
    WELLCOME_BOOTCAMP_REWARDS = '#bootcamp:wellcome/bootcamp/rewards'
    WELLCOME_BOOTCAMP_REWARDS_TANKS = '#bootcamp:wellcome/bootcamp/rewards/tanks'
    WELLCOME_BOOTCAMP_REWARDS_TOOLTIP_TANK = '#bootcamp:wellcome/bootcamp/rewards/tooltip/tank'
    WELLCOME_BOOTCAMP_REWARDS_PREMIUM = '#bootcamp:wellcome/bootcamp/rewards/premium'
    WELLCOME_BOOTCAMP_REWARDS_GOLD = '#bootcamp:wellcome/bootcamp/rewards/gold'
    ...
    BTN_SKIPVIDEO = '#bootcamp:btn/skipVideo'
    BTN_SELECT = '#bootcamp:btn/select'
    BTN_CONTINUE = '#bootcamp:btn/continue'
    BTN_CANCEL = '#bootcamp:btn/cancel'
    ...
    AWARD_OPTIONS_LOCKED = '#bootcamp:award/options/locked'
    AWARD_OPTIONS_NATION_USA = '#bootcamp:award/options/nation/usa'
    AWARD_OPTIONS_NATION_USA_CN = '#bootcamp:award/options/nation/usa_CN'
    AWARD_OPTIONS_NATION_GERMANY = '#bootcamp:award/options/nation/germany'
    AWARD_OPTIONS_NATION_GERMANY_CN = '#bootcamp:award/options/nation/germany_CN'
    AWARD_OPTIONS_NATION_USSR = '#bootcamp:award/options/nation/ussr'
    AWARD_OPTIONS_NATION_USSR_CN = '#bootcamp:award/options/nation/ussr_CN'
    AWARD_OPTIONS_NATION_CHINA = '#bootcamp:award/options/nation/china'
    AWARD_OPTIONS_NATION_CHINA_CN = '#bootcamp:award/options/nation/china_CN'
    AWARD_OPTIONS_NATION_CZECH = '#bootcamp:award/options/nation/czech'
    AWARD_OPTIONS_NATION_CZECH_CN = '#bootcamp:award/options/nation/czech_CN'
    AWARD_OPTIONS_NATION_FRANCE = '#bootcamp:award/options/nation/france'
    AWARD_OPTIONS_NATION_FRANCE_CN = '#bootcamp:award/options/nation/france_CN'
    AWARD_OPTIONS_NATION_ITALY = '#bootcamp:award/options/nation/italy'
    AWARD_OPTIONS_NATION_ITALY_CN = '#bootcamp:award/options/nation/italy_CN'
    AWARD_OPTIONS_NATION_JAPAN = '#bootcamp:award/options/nation/japan'
    AWARD_OPTIONS_NATION_JAPAN_CN = '#bootcamp:award/options/nation/japan_CN'
    AWARD_OPTIONS_NATION_POLAND = '#bootcamp:award/options/nation/poland'
    AWARD_OPTIONS_NATION_POLAND_CN = '#bootcamp:award/options/nation/poland_CN'
    AWARD_OPTIONS_NATION_SWEDEN = '#bootcamp:award/options/nation/sweden'
    AWARD_OPTIONS_NATION_SWEDEN_CN = '#bootcamp:award/options/nation/sweden_CN'
    AWARD_OPTIONS_NATION_UK = '#bootcamp:award/options/nation/uk'
    AWARD_OPTIONS_NATION_UK_CN = '#bootcamp:award/options/nation/uk_CN'
    AWARD_OPTIONS_NAME_USA = '#bootcamp:award/options/name/usa'
    AWARD_OPTIONS_DESCRIPTION_USA = '#bootcamp:award/options/description/usa'
    AWARD_OPTIONS_DESCRIPTION_USA_CN = '#bootcamp:award/options/description/usa_CN'
    AWARD_OPTIONS_NAME_GERMANY = '#bootcamp:award/options/name/germany'
    AWARD_OPTIONS_DESCRIPTION_GERMANY = '#bootcamp:award/options/description/germany'
    AWARD_OPTIONS_DESCRIPTION_GERMANY_CN = '#bootcamp:award/options/description/germany_CN'
    ...
    AWARD_OPTIONS_DESCRIPTION_USSR_CN = '#bootcamp:award/options/description/ussr_CN'
    AWARD_OPTIONS_NAME_CHINA = '#bootcamp:award/options/name/china'
    AWARD_OPTIONS_DESCRIPTION_CHINA = '#bootcamp:award/options/description/china'
    AWARD_OPTIONS_DESCRIPTION_CHINA_CN = '#bootcamp:award/options/description/china_CN'
    AWARD_OPTIONS_NAME_CZECH = '#bootcamp:award/options/name/czech'
    AWARD_OPTIONS_DESCRIPTION_CZECH = '#bootcamp:award/options/description/czech'
    AWARD_OPTIONS_DESCRIPTION_CZECH_CN = '#bootcamp:award/options/description/czech_CN'
    AWARD_OPTIONS_NAME_FRANCE = '#bootcamp:award/options/name/france'
    AWARD_OPTIONS_DESCRIPTION_FRANCE = '#bootcamp:award/options/description/france'
    AWARD_OPTIONS_DESCRIPTION_FRANCE_CN = '#bootcamp:award/options/description/france_CN'
    AWARD_OPTIONS_NAME_ITALY = '#bootcamp:award/options/name/italy'
    AWARD_OPTIONS_DESCRIPTION_ITALY = '#bootcamp:award/options/description/italy'
    AWARD_OPTIONS_DESCRIPTION_ITALY_CN = '#bootcamp:award/options/description/italy_CN'
    AWARD_OPTIONS_NAME_JAPAN = '#bootcamp:award/options/name/japan'
    AWARD_OPTIONS_DESCRIPTION_JAPAN = '#bootcamp:award/options/description/japan'
    AWARD_OPTIONS_DESCRIPTION_JAPAN_CN = '#bootcamp:award/options/description/japan_CN'
    AWARD_OPTIONS_NAME_POLAND = '#bootcamp:award/options/name/poland'
    AWARD_OPTIONS_DESCRIPTION_POLAND = '#bootcamp:award/options/description/poland'
    AWARD_OPTIONS_DESCRIPTION_POLAND_CN = '#bootcamp:award/options/description/poland_CN'
    AWARD_OPTIONS_NAME_SWEDEN = '#bootcamp:award/options/name/sweden'
    AWARD_OPTIONS_DESCRIPTION_SWEDEN = '#bootcamp:award/options/description/sweden'
    AWARD_OPTIONS_DESCRIPTION_SWEDEN_CN = '#bootcamp:award/options/description/sweden_CN'
    AWARD_OPTIONS_NAME_UK = '#bootcamp:award/options/name/uk'
    AWARD_OPTIONS_DESCRIPTION_UK = '#bootcamp:award/options/description/uk'
    AWARD_OPTIONS_DESCRIPTION_UK_CN = '#bootcamp:award/options/description/uk_CN'
    ...
    PREBATTLE_HINT_PENETRATION_CHANCE_HIGH = '#bootcamp:prebattle/hint/penetration/chance/high'
    PREBATTLE_HINT_PENETRATION_CHANCE_LOW = '#bootcamp:prebattle/hint/penetration/chance/low'
    ...
    MESSAGE_UNLOCK_MODULE_BUTTONLABEL = '#bootcamp:message/unlock/module/buttonLabel'
    MESSAGE_UNLOCK_MODULE_TITLE = '#bootcamp:message/unlock/module/title'
    MESSAGE_UNLOCK_VEHICLE_BUTTONLABEL = '#bootcamp:message/unlock/vehicle/buttonLabel'
    MESSAGE_UNLOCK_VEHICLE_TITLE = '#bootcamp:message/unlock/vehicle/title'
    MESSAGE_CONFIRMBUYANDINSTALL_MODULE_BUTTONLABEL = '#bootcamp:message/confirmBuyAndInstall/module/buttonLabel'
    MESSAGE_CONFIRMBUYANDINSTALL_MODULE_TITLE = '#bootcamp:message/confirmBuyAndInstall/module/title'
    ...
    MESSAGE_TEACHING_TEAM_LABEL = '#bootcamp:message/teaching/team/label'
    MESSAGE_TEACHING_TEAM_TEXT = '#bootcamp:message/teaching/team/text'
    ...
    MESSAGE_MISSIONBONUSCOUNT = '#bootcamp:message/missionBonusCount'
    ...
    MESSAGE_GOLDRECEIVED_LABEL = '#bootcamp:message/goldReceived/label'
    MESSAGE_GOLD_LABEL = '#bootcamp:message/gold/label'
    MESSAGE_GOLD_PREMIUM_TEXT = '#bootcamp:message/gold/premium/text'
    MESSAGE_GOLD_PREMIUMPLUS_TEXT = '#bootcamp:message/gold/premiumPlus/text'
    ...
    MESSAGE_PREMIUMPLUSRECEIVED_LABEL = '#bootcamp:message/premiumPlusReceived/label'
    ...
    TOOLTIP_BOOTCAMP_ACHIEVEMENT_LABEL = '#bootcamp:tooltip/bootcamp/achievement/label'
    TOOLTIP_BOOTCAMP_ACHIEVEMENT_TEXT = '#bootcamp:tooltip/bootcamp/achievement/text'
    TOOLTIP_BOOTCAMP_BADGE_LABEL = '#bootcamp:tooltip/bootcamp/badge/label'
    TOOLTIP_BOOTCAMP_BADGE_TEXT = '#bootcamp:tooltip/bootcamp/badge/text'
    MESSAGE_BOOTCAMP_GRADUATE_REFERRAL_TEXT = '#bootcamp:message/bootcamp/graduate/referral/text'
    MESSAGE_BOOTCAMP_REFERRAL_TEXT = '#bootcamp:message/bootcamp/referral/text'
    MESSAGE_START_MESSAGE = '#bootcamp:message/start/message'
    MESSAGE_START_MESSAGE_PREMIUM = '#bootcamp:message/start/message/premium'
    MESSAGE_START_MESSAGE_GOLD = '#bootcamp:message/start/message/gold'
    MESSAGE_START_MESSAGE_CREW = '#bootcamp:message/start/message/crew'
    MESSAGE_START_TITLE = '#bootcamp:message/start/title'
    MESSAGE_START_SUBMIT = '#bootcamp:message/start/submit'
    MESSAGE_START_CANCEL = '#bootcamp:message/start/cancel'
    MESSAGE_RESTART_MESSAGE = '#bootcamp:message/restart/message'
    MESSAGE_RESTART_REWARD = '#bootcamp:message/restart/reward'
    MESSAGE_RESTART_TITLE = '#bootcamp:message/restart/title'
    MESSAGE_RESTART_SUBMIT = '#bootcamp:message/restart/submit'
    MESSAGE_RESTART_CANCEL = '#bootcamp:message/restart/cancel'
    ...
    RESULTLABEL_DEAD = '#bootcamp:resultlabel/dead'
    RESULTLABEL_ALIVE = '#bootcamp:resultlabel/alive'
    RESULTLABEL_TECHWIN = '#bootcamp:resultlabel/techwin'
    RESULTLABEL_ENDED = '#bootcamp:resultlabel/ended'
    REWARD_LABEL = '#bootcamp:reward/label'
    PROGRESSION_LABEL = '#bootcamp:progression/label'
    TOOLTIP_PROGRESSION_LABEL_VEHICLE_SECOND_LEVEL = '#bootcamp:tooltip/progression/label/vehicle_second_level'
    TOOLTIP_PROGRESSION_LABEL_VEHICLE_THIRD_LEVEL = '#bootcamp:tooltip/progression/label/vehicle_third_level'
    TOOLTIP_PROGRESSION_LABEL_GOLD = '#bootcamp:tooltip/progression/label/gold'
    TOOLTIP_PROGRESSION_LABEL_PREMIUM = '#bootcamp:tooltip/progression/label/premium'
    TOOLTIP_PROGRESSION_LABEL_AWARD = '#bootcamp:tooltip/progression/label/award'
    TOOLTIP_PROGRESSION_DESCRIPTION_VEHICLE = '#bootcamp:tooltip/progression/description/vehicle'
    TOOLTIP_PROGRESSION_DESCRIPTION_GOLD = '#bootcamp:tooltip/progression/description/gold'
    TOOLTIP_PROGRESSION_DESCRIPTION_PREMIUM = '#bootcamp:tooltip/progression/description/premium'
    TOOLTIP_PROGRESSION_DESCRIPTION_AWARD = '#bootcamp:tooltip/progression/description/award'
    TOOLTIP_PROGRESSION_STATUS_GOT = '#bootcamp:tooltip/progression/status/got'
    TOOLTIP_PROGRESSION_STATUS_WAIT = '#bootcamp:tooltip/progression/status/wait'
    TOOLTIP_PROGRESSION_STATUS_WAIT_BC_COMPLETED = '#bootcamp:tooltip/progression/status/wait/bc_completed'
    TOOLTIP_PROGRESSION_LABEL_LESSON_1 = '#bootcamp:tooltip/progression/label/lesson_1'
    TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_1 = '#bootcamp:tooltip/progression/description/lesson_1'
    TOOLTIP_PROGRESSION_LABEL_LESSON_2 = '#bootcamp:tooltip/progression/label/lesson_2'
    TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_2 = '#bootcamp:tooltip/progression/description/lesson_2'
    TOOLTIP_PROGRESSION_LABEL_LESSON_3 = '#bootcamp:tooltip/progression/label/lesson_3'
    TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_3 = '#bootcamp:tooltip/progression/description/lesson_3'
    TOOLTIP_PROGRESSION_LABEL_LESSON_4 = '#bootcamp:tooltip/progression/label/lesson_4'
    TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_4 = '#bootcamp:tooltip/progression/description/lesson_4'
    TOOLTIP_PROGRESSION_LABEL_LESSON_5 = '#bootcamp:tooltip/progression/label/lesson_5'
    TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_5 = '#bootcamp:tooltip/progression/description/lesson_5'
    TOOLTIP_PROGRESSION_STATUS_IN_PROGRESS = '#bootcamp:tooltip/progression/status/in_progress'
    TOOLTIP_PROGRESSION_STATUS_COMPLETED = '#bootcamp:tooltip/progression/status/completed'
    ...
    SUBTITLES_VO_BC_HANGAR_TANK_IMPROVEMENT = '#bootcamp:subtitles/vo_bc_hangar_tank_improvement'
    SUBTITLES_VO_BC_HANGAR_EXPERIENCE = '#bootcamp:subtitles/vo_bc_hangar_experience'
    SUBTITLES_VO_BC_HANGAR_MODULE_INVESTIGATED = '#bootcamp:subtitles/vo_bc_hangar_module_investigated'
    SUBTITLES_VO_BC_HANGAR_SILVER = '#bootcamp:subtitles/vo_bc_hangar_silver'
    SUBTITLES_VO_BC_HANGAR_MODULE_PURCHASED = '#bootcamp:subtitles/vo_bc_hangar_module_purchased'
    SUBTITLES_VO_BC_HANGAR_NEW_TANK_RECEIVED = '#bootcamp:subtitles/vo_bc_hangar_new_tank_received'
    SUBTITLES_VO_BC_HANGAR_TANK_INVESTIGATED = '#bootcamp:subtitles/vo_bc_hangar_tank_investigated'
    SUBTITLES_VO_BC_HANGAR_TANK_IN_GARAGE = '#bootcamp:subtitles/vo_bc_hangar_tank_in_garage'
    SUBTITLES_VO_BC_HANGAR_TEAM = '#bootcamp:subtitles/vo_bc_hangar_team'
    SUBTITLES_VO_BC_HANGAR_SKILLS_ABILITIES = '#bootcamp:subtitles/vo_bc_hangar_skills_abilities'
    SUBTITLES_VO_BC_HANGAR_EQUIPMENT_AND_KIT = '#bootcamp:subtitles/vo_bc_hangar_equipment_and_kit'
    SUBTITLES_VO_BC_HANGAR_KIT = '#bootcamp:subtitles/vo_bc_hangar_kit'
    SUBTITLES_VO_BC_HANGAR_EQUIPMENT = '#bootcamp:subtitles/vo_bc_hangar_equipment'
    SUBTITLES_VO_BC_HANGAR_RANDOM_BATTLE = '#bootcamp:subtitles/vo_bc_hangar_random_battle'
    SUBTITLES_VO_BC_HANGAR_GOLD_PREMIUM = '#bootcamp:subtitles/vo_bc_hangar_gold_premium'
    SUBTITLES_VO_BC_HANGAR_GOLD = '#bootcamp:subtitles/vo_bc_hangar_gold'
    SUBTITLES_VO_BC_HANGAR_PREMIUM = '#bootcamp:subtitles/vo_bc_hangar_premium'
    SUBTITLES_VO_BC_HANGAR_MISSION_ACCOMPLISHED = '#bootcamp:subtitles/vo_bc_hangar_mission_accomplished'
    SUBTITLES_VO_BC_HANGAR_CONGRATULATIONS = '#bootcamp:subtitles/vo_bc_hangar_congratulations'
    PROGRESS_WIDGET_TITLE = '#bootcamp:progress/widget/title'
    PROGRESS_WINDOW_TITLE = '#bootcamp:progress/window/title'
    PROGRESS_WINDOW_DESCRIPTION = '#bootcamp:progress/window/description'
    PROGRESS_WINDOW_EXIT = '#bootcamp:progress/window/exit'
    PROGRESS_REWARDS_TAKEN_SHORT = '#bootcamp:progress/rewards/taken_short'
    PROGRESS_REWARDS_TAKEN = '#bootcamp:progress/rewards/taken'
    EXITWINDOW_TITLE = '#bootcamp:exitWindow/title'
    EXITWINDOW_DESCRIPTION = '#bootcamp:exitWindow/description'
    EXITWINDOW_REFERRAL_DESCRIPTION = '#bootcamp:exitWindow/referral/description'
    EXITWINDOW_STAY = '#bootcamp:exitWindow/stay'
    EXITWINDOW_LEAVE = '#bootcamp:exitWindow/leave'
