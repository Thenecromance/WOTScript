# Embedded file name: scripts/client/gui/Scaleform/daapi/view/meta/VehiclePreviewEventProgressionBuyingPanelMeta.py
from gui.Scaleform.framework.entities.BaseDAAPIComponent import BaseDAAPIComponent

class VehiclePreviewEventProgressionBuyingPanelMeta(BaseDAAPIComponent):
