# Embedded file name: scripts/client/gui/Scaleform/daapi/view/meta/VehiclePreviewOfferGiftBuyingPanelMeta.py
from gui.Scaleform.framework.entities.BaseDAAPIComponent import BaseDAAPIComponent

class VehiclePreviewOfferGiftBuyingPanelMeta(BaseDAAPIComponent):
