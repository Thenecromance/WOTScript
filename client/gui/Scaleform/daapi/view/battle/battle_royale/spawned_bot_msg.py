# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/battle_royale/spawned_bot_msg.py
import logging
import BigWorld
    ...
    def __onArenaVehicleKilled(self, targetID, attackerID, equipmentID, reason):
        ...
        if killedVehicle is None:
            ...
            if killedVehicle.getMasterVehID() == playerVehicleId:
                self.__sessionProvider.shared.messages.onShowPlayerMessageByKey(self.SPAWNED_BOT_DESTROYED_ID)
            return