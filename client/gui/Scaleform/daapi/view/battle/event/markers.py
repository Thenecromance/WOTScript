...
class World2DIndexedMarkerComponent(World2DLocationMarkerComponent):
    ...
    def _entityIndex(self):
        if self._entity and 'entityInfo' in self._entity.dynamicComponents:
            return self._entity.entityInfo.index
        return 0
...
class World2DCampMarkerComponent(World2DFollowerMarkerComponent):
    ...
    def getAlpha(self):
        if self._playerBombID:
            return self._BOMB_FOLLOWER_ALPHA
        return super(World2DCampMarkerComponent, self).getAlpha()
    ...
    def _symbol(self):
        if isBoss():
            return 'AllyCampLocationMarkerUI'
        return 'EnemyCampLocationMarkerUI'
...
class World2DGeneratorMarkerComponent(World2DFollowerMarkerComponent):
    ...
    @property
    def _symbol(self):
        return 'GeneratorLocationMarkerUI'
...
class World2DBombMarkerComponent(World2DFollowerMarkerComponent):
    ...
    @property
    def _symbol(self):
        return 'BombLocationMarkerUI'

    @property
    def _followeeID(self):
        if self._entity and 'follower' in self._entity.dynamicComponents:
            return self._entity.follower.followeeID
        else:
            return None
