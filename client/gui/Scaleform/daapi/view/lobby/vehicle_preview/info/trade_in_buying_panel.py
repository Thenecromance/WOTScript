# Embedded file name: scripts/client/gui/Scaleform/daapi/view/lobby/vehicle_preview/info/trade_in_buying_panel.py
...
class VehiclePreviewTradeInBuyingPanel(VehiclePreviewTradeInBuyingPanelMeta):
    ...
    def __getSelectedPrice(self):
        if self.__tradeOffVehicle is None:
            return
        else:
            return getItemPricesVO(ItemPrice(self.__tradeOffVehicle.tradeOffPrice, self.__tradeOffVehicle.tradeOffPrice))
