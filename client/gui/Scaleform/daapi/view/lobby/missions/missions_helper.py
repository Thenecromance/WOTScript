...
class _DetailedPersonalMissionInfo(_MissionInfo):
    ...
    def __getAddBottomInfo(self):
        ...
        if quest.getQuestBranch() == PM_BRANCH.PERSONAL_MISSION_2:
    ...
    def __getAddBottomLocked(self):
        ...
        if quest.getQuestBranch() == PM_BRANCH.PERSONAL_MISSION_2:
            return text_styles.error(_ms(QUESTS.PERSONALMISSION_STATUS_ADDBOTTOMLOCKED_PM2, vehType=vehType, minLevel=minLevel, maxLevel=maxLevel))
        return ''
