...
class ClientArena(object):
    ...
    def getArenaBB(self):
        if self.__arenaBBCollider is None and not self.__setupBBColliders():
            ...
            return (self.__arenaBBCollider.getMinBounds(), self.__arenaBBCollider.getMaxBounds())
    ...
    def getSpaceBB(self):
        if self.__spaceBBCollider is None and not self.__setupBBColliders():
            ...
            return (self.__spaceBBCollider.getMinBounds(), self.__spaceBBCollider.getMaxBounds())
